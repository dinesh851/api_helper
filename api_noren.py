...
class NorenApi:
    ...
    def __init__(self):
        self.__service_config['host'] = 'https://api.shoonya.com/NorenWClientTP/' #host
        self.__service_config['websocket_endpoint'] = 'wss://api.shoonya.com/NorenWSTP/' #websocket
        self.__service_config['eoddata_endpoint'] = 'https://api.shoonya.com/chartApi/getdata/' #eodhost
    ...
    def start_websocket(self, subscribe_callback = None, 
        ...
        self.__websocket = websocket.WebSocket(url,
